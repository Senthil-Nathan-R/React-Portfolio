...
function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    // Create an object with the required fields for your EmailJS template
    const templateParams = {
      to_name: "Senthil Nathan",
    ...
    emailjs.send("service_pbqlycs", "template_iu0bru1", templateParams, 'UdvN19TKjY65Si_G2')
      .then((result) => {
        ...
        console.log('Email sending error:', error); // Log the full error for debugging
        setDialogState({
          open: true,
  ...
  return (
    <>
      ...
      <section className='container px-4 mx-auto'>
        ...
        <p className='text-accent my-20'>If you prefer to send an email directly instead of using the form, feel free to reach out to me at <span className='font-bold italic'>r.senthil18112002@gmail.com</span>. Whether you have a specific project in mind, a question, or just want to connect, I'm always happy to hear from you. Click <a href="mailto:r.senthil18112002@gmail.com" className='text-white underline'>here</a> to send an email directly.</p>
