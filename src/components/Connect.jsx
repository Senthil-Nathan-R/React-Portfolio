...
<p className='text-white relative text-2xl sm:text-3xl md:text-[44px] text-center font-bold font-cairo mx-3 tracking-wide'>
  Let's create something <i>amazing</i> together!
</p>
