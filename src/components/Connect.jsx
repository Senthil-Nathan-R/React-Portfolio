...
function Connect() {
    return (
        <div className='rounded-xl py-12 md:py-16 px-2 flex flex-col items-center shadow-lg  bg-gradient-to-tr from-primary to-[#010b139a] shadow-[#44adf813] relative mb-14' >
            ...
            <p className='text-white relative text-4xl md:text-[44px] sm:text-[30px] text-center font-bold font-cairo mx-3 tracking-wide'>Let's create something <i>amazing</i> together!</p>
